...
function tinyjpfont_load_custom_fonts($init) {
    ...
    $custom_fonts = ';'.'ふい字=Huifont;Noto Sans Japanese=Noto Sans Japanese;太字なNoto Sans Japanese=Noto Sans Japanese-400;細字なNoto Sans Japanese=Noto Sans Japanese-100';
