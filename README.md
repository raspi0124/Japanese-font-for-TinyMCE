...
フォントは `fonts.raspi0124.dev` から配信します。対応するWordPressではFont Libraryの「日本語フォント」から必要な書体だけをインストールし、サイトから配信できます。インストールは任意です。

変更点は [CHANGELOG.md](CHANGELOG.md)、詳しい使い方・配信条件は [readme.txt](readme.txt)、互換性の検証結果は [検証報告](docs/verification-5.00/README.md) を参照してください。
